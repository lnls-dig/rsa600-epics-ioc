...
/* Generated from ../O.Common/rsa.dbd */
...
int rsa_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/joao/Documents/Diagnostics/Tune/rsa-epics-ioc";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"rsa_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    rsa_registerRecordDeviceDriver(*iocshPpdbbase);
}
